...
- NVIDIA NIM model presets now include explicit Nano Omni and Ultra 550B A55B selectable options, and default preset labels now use `Default Models`
