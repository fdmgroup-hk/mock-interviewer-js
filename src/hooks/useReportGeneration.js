...
export function useReportGeneration() {
    ...
    return {
        ...
        coachReportMarkdownPreview: state.coachReportMarkdownPreview,
        setCoachReportMarkdownPreview: (value) => setField('coachReportMarkdownPreview', value),
        ...
        coachReportPdfPreviewUrl: state.coachReportPdfPreviewUrl,
        setCoachReportPdfPreviewUrl: (value) => setField('coachReportPdfPreviewUrl', value),
        coachReportPdfBlob: state.coachReportPdfBlob,
        setCoachReportPdfBlob: (value) => setField('coachReportPdfBlob', value),
        coachReportPdfFileName: state.coachReportPdfFileName,
        setCoachReportPdfFileName: (value) => setField('coachReportPdfFileName', value),
